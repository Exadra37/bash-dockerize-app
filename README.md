...
Check [Milestones](https://gitlab.com/exadra37-bash/dockerize-app/milestones) to see what Goals I want to achieve.

Watch [Boards](https://gitlab.com/exadra37-bash/dockerize-app/boards) to keep track of what is going on.
